 ...
 */
public class Z21ActionGetSignalInfo extends Z21Action {
   ...
   */
  public Z21ActionGetSignalInfo(Z21 z21, int locoAddress ) throws LocoAddressOutOfRangeException {
    super( z21 );
  ...
  public void addDataToByteRepresentation( Object[] objs ) {
    //Add all the data
    byteRepresentation.add( (byte) (int) Integer.decode( "0x43" ) );
//    byteRepresentation.add( (byte) (int) Integer.decode( "0xF0" ) );
    ...
    byteRepresentation.add( (byte) (byteRepresentation.get( 2 ) ^ byteRepresentation.get( 3 ) ^ byteRepresentation.get( 4 )) );
  }
}
