...
public class BroadcastFlagHandler {
  ...
  public static void setReceive( Z21 z21, BroadcastFlags flag, boolean receive ) {
    switch (flag) {
...
class Z21ActionLanSetBroadcastFlags extends Z21Action {
  public Z21ActionLanSetBroadcastFlags( Z21 z21, boolean receiveGlobalBroadcasts, boolean receiveAllLocos, boolean receiveCentreStatus ) {
    super( z21 );
